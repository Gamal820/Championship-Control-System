...
public partial class FootballProDbContext : DbContext
{
    public FootballProDbContext()
    {
    }

    public FootballProDbContext(DbContextOptions<FootballProDbContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=.;Database=FootballProDB;Trusted_Connection=True;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
            ...
            entity.HasMany(d => d.Championships).WithMany(p => p.Teams)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        ...
                        j.IndexerProperty<int>("ChampionshipId").HasColumnName("ChampionshipID");
                    });
        });
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__User__1788CCACC45B4A85");

            entity.ToTable("User");

            entity.HasIndex(e => e.Username, "UQ__User__536C85E4DFAED092").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__User__A9D105348A6FC3E7").IsUnique();
            ...
            entity.HasMany(d => d.Events).WithMany(p => p.Users)
                .UsingEntity<Dictionary<string, object>>(
                    "UserSeeEvent",
                    r => r.HasOne<MatchEvent>().WithMany()
