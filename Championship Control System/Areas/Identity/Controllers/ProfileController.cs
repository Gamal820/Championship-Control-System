...
namespace Championship_Control_System.Areas.Identity.Controllers
{
    [Area("Identity")]
    [Authorize]
    public class ProfileController : Controller
    {
        ...
        public async Task<IActionResult> UpdatePassword(ApplicationUserVM applicationUserVM)
        {
            ...
            if (applicationUserVM.CurrentPassword is null || applicationUserVM.NewPassword is null || applicationUserVM.ConfirmNewPassword is null)
            {
                TempData["error-notification"] = "All password fields are required ";
                return RedirectToAction(nameof(Index));
            }
